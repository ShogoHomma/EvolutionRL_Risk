...
names_randmulti_rds <- c("df_agent_randmulti_22.RDS", "df_agent_randmulti_31.RDS", "df_agent_randmulti_13.RDS", "df_agent_randmulti_04.RDS", "df_agent_randmulti_40.RDS")
...
# saveRDS(df_beha_trial_randmulti_summary, file = here("Data", "Evo_RandMultiTask", "df_beha_trial_randmulti_summary.RDS"))
```
...
df_beha_trial_randmulti_summary <- readRDS(here("Data", "Evo_RandMultiTask", "df_beha_trial_randmulti_summary.RDS"))
...
# -> this simulation code is identical to that of Figures_for_Paper.Rmd. So if you already run it, you need not run this code.

# load para info of the first and last generation

df_para_agent_randmulti_FisrtLastGene <- readRDS(here("Data", "Evo_RandMultiTask", "df_para_agent_randmulti_FirstLastGene.RDS"))
...
df_agent_randmulti_Last <- df_para_agent_randmulti_FisrtLastGene %>% 
...
df_agent_randmulti_First <- df_para_agent_randmulti_FisrtLastGene %>% 
...
# para info of the first and last generation
df_para_agent_randmulti_FisrtLastGene <- readRDS(here("Data", "Evo_RandMultiTask", "df_para_agent_randmulti_FirstLastGene.RDS"))

df_agent_randmulti_Last <-
  df_para_agent_randmulti_FisrtLastGene %>% 
  dplyr::filter(generation == 2999)
...
names_randmulti_sLR_rds <- c("df_agent_randmulti_sLR_22.RDS", "df_agent_randmulti_sLR_31.RDS", "df_agent_randmulti_sLR_13.RDS", "df_agent_randmulti_sLR_04.RDS", "df_agent_randmulti_sLR_40.RDS")
...
#  [1] pillar_1.7.0      compiler_4.1.0    forcats_0.5.1     tools_4.1.0       digest_0.6.29    
#  [6] evaluate_0.15     lifecycle_1.0.1   tibble_3.1.6      gtable_0.3.0      pkgconfig_2.0.3  
# [11] rlang_1.0.2       DBI_1.1.2         cli_3.2.0         yaml_2.3.5        xfun_0.30        
# [16] fastmap_1.1.0     stringr_1.4.0     dplyr_1.0.8       knitr_1.38        hms_1.1.1        
# [21] generics_0.1.2    vctrs_0.3.8       htmlwidgets_1.5.4 grid_4.1.0        tidyselect_1.1.2 
# [26] glue_1.6.2        data.table_1.14.6 R6_2.5.1          fansi_1.0.3       rmarkdown_2.13   
# [31] tzdb_0.3.0        readr_2.1.2       purrr_0.3.4       tidyr_1.2.0       ggplot2_3.3.5    
# [36] magrittr_2.0.2    scales_1.1.1      ellipsis_0.3.2    htmltools_0.5.2   assertthat_0.2.1 
# [41] formattable_0.2.1 colorspace_2.0-3  utf8_1.2.2        stringi_1.7.6     munsell_0.5.0    
# [46] crayon_1.5.1  
