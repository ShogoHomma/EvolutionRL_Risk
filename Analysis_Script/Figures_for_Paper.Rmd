...
df_trial_randmulti_simMEAN %>% 
  ...
  theme(axis.text.x = element_text(size = 15),
        ...
        axis.title = element_text(size = 20, face = "bold"),
        strip.text.x = element_text(size = 15)) + 
  scale_color_manual(values=c("#44039EFF", "#F79044FF")) + 
  scale_fill_manual(values=c("#44039EFF", "#F79044FF")) + 
  coord_cartesian(ylim = c(0, 1)) + 
  labs(x = "Trial",
       y = "Rate of risk aversion",
       color = "task",
...
- リスク回避率 90%以上、10%以下の頻度%をそれぞれ求める
...
- リスク回避率について、プロスペクト理論的な振る舞いのエージェントを取り出す
