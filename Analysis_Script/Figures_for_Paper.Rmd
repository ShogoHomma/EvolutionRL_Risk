...
g <- VisEvol_RiskAversion(df_gene_riskaversion_mean, target_sim, "Risk-aversion task")
  
ggsave(plot = g, filename = here(output_path, "Fig3.1_Evo_RiskAversion_risk-aversion_6_2.png"), width = 15.0, height = 6.0)
```
...
g <- VisEvol_RiskAversion(df_gene_riskaversion_mean, target_sim, "Risk-seeking task")

ggsave(plot = g, filename = here(output_path, "Fig3.2_Evo_RiskAversion_risk-seeking_6_2.png"), width = 15.0, height = 6.0)
```


## Fig.4 単一：全シミュレーション リスク回避率
...
ggsave(plot = g, filename = here(output_path, "Fig4.1_LastGene_RiskAversion_risk-aversion_inrow.png"), width = 20.0, height = 6.0)
```
...
ggsave(plot = g, filename = here(output_path, "Fig4.2_LastGene_RiskAversion_risk-seeking_inrow.png"), width = 20.0, height = 6.0)
```


## Fig.5 単一：6つの典型的な結果 進化
...
ggsave(plot = g, filename = here(output_path, "Fig5.1_Evo_apan_risk-aversion_6.png"), width = 15.0, height = 6.0)
```
...
ggsave(plot = g, filename = here(output_path, "Fig5.2_Evo_apan_risk-seeking_6.png"), width = 15.0, height = 6.0)
```


## Fig.6 単一：全シミュレーション 進化
...
ggsave(plot = g, filename = here(output_path, "Fig6.1_LastGene_apan_risk-aversion_inrow.png"), width = 20.0, height = 6.0)
```
...
ggsave(plot = g, filename = here(output_path, "Fig6.2_LastGene_apan_risk-seeking_inrow.png"), width = 20.0, height = 6.0)
```
...
ggsave(plot = g, filename = here(output_path, "Fig7_Evo_apan_Multi_PosiNega.png"), width = 10.0, height = 6.0)
```
