...
ggsave(plot = g, filename = here(output_path, "Fig10_1_ExpChange_risk_aversion_bt_inrow.png"), width = 20.0, height = 6.0)
```
...
ggsave(plot = g, filename = here(output_path, "Fig10_2_ExpChange_risk_seeking_bt_inrow.png"), width = 20.0, height = 6.0)
```
