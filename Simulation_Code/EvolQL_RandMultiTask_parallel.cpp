...
void saveData::create_dir(string filename) {
    ...
    */
    ...
    system_order_st_cp = "cp EvolQL_RandMultiTask_parallel.cpp ";
...
void saveData::create_file() {
    ...
    */
    ...
    if (!ofs2) {
        ...
        //ofs2 << "sim,generation,agent,task,ancestor,mean_payoff,mean_p,fitness,rate_choice1,rate0to0,rate0to1,rate1to0,rate1to1,ap,an,bt" << endl;
    ...
    if (!ofs3) {
        ...
        ofs3 << "sim,generation,mean_ap,mean_an,mean_bt,sd_ap,sd_an,sd_bt" << endl;
    }
...
void saveData::recordData_trial(Agent agent, int sim_i, int gene_i, int pop_i, int task_i, int trial_i) {
    ...
    double output[14] = {(double)sim_i, (double)gene_i, (double)agent.return_ID(), (double)task_i, (double)trial_i, \
...
void saveData::recordData_nat(Agent agent, int sim_i, int gene_i, int pop_i, int task_i) {
    ...
    double output[16] = {(double)sim_i, (double)gene_i, (double)agent.return_ID(), (double)task_i, (double)agent.return_Offspring(), agent.return_MeanPayoff(task_i), \
...
void saveData::recordData_gene(Agent agent, int sim_i, int gene_i, int pop_i) {
    ...
    if (pop_i == PopSize - 1) {
        ...
        double output[8] = {(double)sim_i, (double)gene_i, mean_ap, mean_an, mean_bt, sd_ap, sd_an, sd_bt};
